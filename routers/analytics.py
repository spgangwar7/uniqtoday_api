    ...
    try:
        ...
        if data1.empty:
            ...
            if not data.empty:
                ...
                weakly_total_unattempted_questions = data.groupby(
                    pd.Grouper(freq='W', key='date')).unattempted_questions.sum()
                ...
                weaklyframes = [weakly_total_correct, weakly_total_incorrect, weakly_total_unattempted_questions,
                                ...
                                weakly_time_spent_on_correct_ques_for_class,
                                weakly_time_spent_on_incorrect_ques_for_class,
                                weakly_time_spent_on_each_ques_for_class,
                                weakly_time_spent_on_each_question, weakly_correct_percentage,
                                weakly_incorrect_percentage,
                ...
                monthly_total_unattempted_questions = data.groupby(
                    pd.Grouper(freq='M', key='date')).unattempted_questions.sum()
                ...
                monthlyFrames = [monthly_total_correct, monthly_total_incorrect, monthly_total_unattempted_questions,
                                 ...
                                 monthly_time_spent_on_correct_ques_for_class,
                                 monthly_time_spent_on_incorrect_ques_for_class,
                ...
                data["time_spent_on_correct_ques"] = data["time_spent_on_correct_ques"].apply(td_to_str)
                data['time_spent_on_incorrect_ques'] = data['time_spent_on_incorrect_ques'].apply(td_to_str)
                data["time_spent_on_each_question_for_class"] = data['time_spent_on_each_question_for_class'].apply(
                    td_to_str)
                data['time_spent_on_correct_ques_for_class'] = data["time_spent_on_correct_ques_for_class"].apply(
                    td_to_str)
                data['time_spent_on_incorrect_ques_for_class'] = data['time_spent_on_incorrect_ques_for_class'].apply(
                    td_to_str)
            else:
                weaklyReport = pd.DataFrame()
                monthlyReport = pd.DataFrame()
